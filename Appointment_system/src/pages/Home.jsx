    ...
    <section className="hero_section 2xl:h-[800px]">
      ...
      <div className='container'>
        ...
        <div className=' w-full'>
            ...
            <div className=''>
                <div className=''>
                    <h1 className='text-[36px] leading-[36px]
                     text-gray-800  md:text-[60px] font-[600] md:leading-[70px]'>We help patients lead a healthy, happy life
                    </h1>
                    <p className='text_para '>Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                     Eius, obcaecati minus aliquid aliquam facere accusantium atque 
                     doloribus? Numquam at temporibus ipsum voluptate architecto! Quam veniam q
                     uas fugiat repellat laudantium tempore?
                    </p>
                    <button className='btn border-4 border-black hover:bg-blue-500'>Book an Appointment</button>
                </div>
                <div className='mt-[25px] flex flex-col lg:flex-row lg:items-center lg:mt-[40px] gap-5 lg:gap-30px'>
                    <div>
                        <h2 className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-gray-800'>30+</h2>
                        <span className='block h-2 w-[100px] bg-yellow-300 rounded-full mt-[-12px]'></span>
                        <p className='text_para'>Years of Experience</p>
                    </div>
                    <div>
                        <h2 className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-gray-800'>10+</h2>
                        <span className='block h-2 w-[100px] bg-purple-600 rounded-full mt-[-12px]'></span>
                        <p className='text_para'>Locations</p>
                    </div>
                    <div>
                        <h2 className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-gray-800'>100%</h2>
        ...
        <div className="container">
            <div className='lg:w-[480px] mx-auto pt-10' >
                ...
                <p className='text_para text-center'>
                    Unmatched world-class medical care for everyone.
                    We&apos;re a large family of experienced medical staff
                </p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] lg:mt-[55px]'>
                ...
                <div className='py-[30px] px-5'>
                    ...
                    <div className='mt-[30px]'>
                        <h2 className='text-[26px] leading-9 text-gray-900 
                        font-[700] text-center'>Find a doctor</h2>
                        <p className='text-[16px] leading-7 text-gray-800 font-[400] text-center mt-4'>World class healthcare for everyone. 
                        Our staff consists of medical experts from around the world. 
                        </p>

                        <Link to="/doctors" className='w-[40px] h-[40px] rounded-full border 
                ...
                <div className='py-[30px] px-5'>
                    ...
                    <div className='mt-[30px]'>
                        <h2 className='text-[26px] leading-9 text-gray-900 
                        font-[700] text-center'>Leading experts</h2>
                        <p className='text-[16px] leading-7 text-gray-800 font-[400] text-center mt-4'>World class healthcare for everyone. 
                        Our staff consists of medical experts from around the world. 
                        </p>
                ...
                <div className='py-[30px] px-5'>
                    ...
                    <div className='mt-[30px]'>
                        <h2 className='text-[26px] leading-9 text-gray-900 
                        font-[700] text-center'>Experienced staff</h2>
                        <p className='text-[16px] leading-7 text-gray-800 font-[400] text-center mt-4'>World class healthcare for everyone. 
                        Our staff consists of medical experts from around the world. 
                        </p>
        ...
        <div className="container">
            <div className="flex items-center justify-between flex-col lg:flex-row pb-8 lg:pb-[55px]">
                <div className='xl:w-[670px]'>
                    <h2 className="heading">Book an appointment<br/> the easy way</h2>
                    <ul className='pl-4'>
                        <li className="text_para">1.Browse our list of doctors</li>
                        <li className="text_para">2. Choose your preferred doctor</li>
                        <li className="text_para">3. Schedule at your most convenient time</li>
                ...
                <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
                    <img src={featuredoc} alt="featuredoc" className='rounded-3xl' />
